...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/Engagecraft-Solutions/gaming-core-ios-espn", exact: "1.0.11"),
    ...
    targets: [
        .target( 
            ...
            dependencies: [
                ...
                .product(name: "GHMainTheme", package: "gaming-core-ios-espn"),
